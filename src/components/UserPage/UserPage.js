...
export default class UserPage extends Component {
  ...
  componentDidMount() {
    //check user is logged in on session
    //get user data
    //also TODO logout bt that will destroy session
    axios.get("/check").then(resp => {
      console.log(resp.data);
      const { preferences, loggedIn } = resp.data;
  ...
  savePreferences() {
    //preferences object
    //bgc, fontColor, favoriteThing, title, message, fontIndex

    axios.put("/preferences", this.state.preferences).then(resp => {});
